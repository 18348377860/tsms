  ...
  <body>
        ...
        <div id="pf-hd">
            ...
            <div class="pf-user">
                ...
                <!--用户名-->
                <h4 class="pf-user-name ellipsis" id=""></h4>
                   ...
                   <li>             	
                     ...
                     <li>
                        ...
                        <ul class="sider-nav-s">
                            <li class="active"><a href="javascript:addTab('任务查询','../../toTaxSource.action?method=list')">调查任务查询</a></li>
                            <li><a href="javascript:addTab('调查任务录入','../../toTaxSource.action?method=add')">调查任务录入</a></li>
